...
const passwordReset = (email, resetLink) => ({
  ...
  html: wrapper('Reset Password — Pehenavas', `
    <div style="text-align:center;margin-bottom:32px;">
      <div style="width:64px;height:64px;border-radius:50%;background-color:#fef3c7;margin:0 auto 20px;line-height:64px;">
...
const emailVerification = (name, verifyLink) => ({
  ...
  html: wrapper('Verify Email — Pehenavas', `
    <div style="text-align:center;margin-bottom:32px;">
      <div style="width:64px;height:64px;border-radius:50%;background-color:#d1fae5;margin:0 auto 20px;line-height:64px;">
        <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="vertical-align:middle;">
...
export { passwordReset, emailVerification, welcomeEmail };
