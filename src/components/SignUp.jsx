...
const SignUp = () => {
  ...
  const validate = () => {
    ...
    if (!agreeTerms) {
      newErrors.agreeTerms = 'You must agree to the terms and conditions to create an account.';
    }
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-amber-100">
          ...
          <div className="px-8 py-4 bg-gradient-to-r from-rose-50 to-amber-50 border-t border-amber-100">
            <p className="text-center text-xs text-gray-600">
              ...
              <Link to="/signin" className="font-semibold text-amber-600 hover:text-rose-950 transition-colors">
                Sign In
              </Link>
            </p>
          </div>
